...
[ `cat hello2` == 3 ] || echo "Wrong number of threads assigned to thread variable in multi statement"

[ `cat hello3` == 3 ] || echo "Wrong number of threads assigned to thread variable in multi statement"
